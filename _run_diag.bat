...
C:\GIT\FreeCAD\build\debug\bin\FreeCADCmd.exe -c "exec(open(r'C:\GIT\FreeCAD\_d.py').read())" > C:\GIT\FreeCAD\_d_out.txt 2>&1
echo EXIT=%ERRORLEVEL% >> C:\GIT\FreeCAD\_d_out.txt
