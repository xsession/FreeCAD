...
_TUTORIAL_COVERAGE = (
    ...
    TutorialCoverageEntry("buildings", "Wind around Buildings", "https://help.sim-flow.com/tutorials/buildings", "Foundation CFD", "Phase 0", "CFD", "steady atmospheric external flow", "starter-scaffold-implemented", ("study-recipe", "external-flow", "atmospheric-inlet", "clip-postprocessing")),
    TutorialCoverageEntry("airfoil-naca-0012", "Airfoil (NACA 0012)", "https://help.sim-flow.com/tutorials/airfoil-naca-0012", "Foundation CFD", "Phase 0", "CFD", "2D airfoil external flow", "starter-scaffold-implemented", ("study-recipe", "airfoil-helper", "force-coefficients", "angle-of-attack")),
    ...
    TutorialCoverageEntry("tesla-valve", "Tesla Valve", "https://help.sim-flow.com/tutorials/tesla-valve", "Foundation CFD", "Phase 0", "CFD", "steady internal flow with periodic interface", "starter-scaffold-implemented", ("study-recipe", "periodic-interface", "2d-plate", "pressure-jump")),
    TutorialCoverageEntry("von-karman-vortex-street", "Von Karman Vortex Street", "https://help.sim-flow.com/tutorials/von-karman-vortex-street", "Foundation CFD", "Phase 0", "CFD", "transient 2D validation case", "starter-scaffold-implemented", ("study-recipe", "validation-case", "forces", "parameterized-geometry")),
    ...
    TutorialCoverageEntry("cooling-channel", "Cooling Channel", "https://help.sim-flow.com/tutorials/cooling-channel", "Thermal / CHT", "Phase 1", "CFD", "steady conjugate heat transfer multi-zone flow", "starter-scaffold-implemented", ("study-recipe", "cht", "multi-region", "thermal-bcs")),
