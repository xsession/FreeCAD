...
_PROFILES = {
    ...
    "Optical": WorkflowProfile(
        ...
        description="CST-inspired optical workflow for components, sources, detectors, and post-processing.",
        workflows=("Non-sequential ray trace", "Illumination", "Wave optics"),
        steps=_with_overrides(_BASE_STEPS, {
            ...
            5: {"name": "Define Sources, Detectors, and Boundaries", "description": "Place sources, detector planes, and optical boundaries on the selected geometry.", "command_name": "FlowStudio_BC_OpticalSource", "hint": "Add at least one optical source or detector and the needed optical boundaries."},
            ...
            7: {"status_key": "optical_controls", "name": "Review Study Controls", "description": "Check ray count, wavelength span, PML, and requested optical outputs.", "command_name": "FlowStudio_OpticalPhysics", "hint": "Review optical physics and solver controls before launch."},
