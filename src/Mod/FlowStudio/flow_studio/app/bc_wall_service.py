...
"""Application service for FlowStudio wall boundary task panels."""

from __future__ import annotations


class FlowStudioWallBoundaryService:
    """Backend-facing service for wall boundary settings persistence."""
