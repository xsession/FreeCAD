...
C:\GIT\FreeCAD\build\debug\bin\FreeCADCmd.exe -c "exec(open(r'C:\GIT\FreeCAD\_d2.py').read())" 1>> C:\GIT\FreeCAD\_t2.txt 2>> C:\GIT\FreeCAD\_t2.txt
echo EC=%ERRORLEVEL% >> C:\GIT\FreeCAD\_t2.txt
